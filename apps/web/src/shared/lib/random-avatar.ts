...
const MALE_HAIRS = [
  'hat', 'variant01', 'variant05', 'variant06', 'variant07', 'variant12',
  'variant13', 'variant15', 'variant16', 'variant18', 'variant19', 'variant20',
  'variant21', 'variant22', 'variant24', 'variant25', 'variant26', 'variant27',
  'variant31', 'variant32', 'variant33', 'variant34', 'variant35', 'variant38',
  'variant40', 'variant44', 'variant49', 'variant54', 'variant55', 'variant56',
  'variant60', 'variant61',
];

const FEMALE_HAIRS = [
  'variant02', 'variant04', 'variant08', 'variant09', 'variant10', 'variant11',
  'variant23', 'variant28', 'variant29', 'variant30', 'variant36', 'variant37',
  'variant39', 'variant41', 'variant45', 'variant46', 'variant47', 'variant48',
  'variant57', 'variant59', 'variant62', 'variant63',
];
