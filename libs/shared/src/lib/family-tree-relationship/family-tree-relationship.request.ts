...
export {
  ...
  type FamilyTreeRelationshipCreateRequestType,
  type FamilyTreeRelationshipCreateSonOrDaughterRequestType,
  type FamilyTreeRelationshipUpdateRequestType,
  type FamilyTreeRelationshipFamilyTreeIdParamType,
  type FamilyTreeRelationshipFamilyTreeIdAndUserIdParamType,
};
